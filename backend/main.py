...
This module creates a FastAPI application instance and wires up the various
routers that implement the public API. It is intentionally light‑weight so
deployment scripts can import `app` without side effects.
"""
...
app = FastAPI(
    ...
    version="0.1.0",
    description="API for managing financial cases, uploading data and generating reports."
)
